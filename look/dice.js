...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-e3b8128b');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-e3b8128b');}
...
var brandEl=document.querySelector('.rl-brand-e3b8128b');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
